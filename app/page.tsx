...
export default function Personal() {
  return (
    ...
    >
      ...
      >
        <div className="flex-1 selection:bg-highlight_yellow/50 selection:text-black dark:selection:bg-highlight_yellow_dark/10 dark:selection:text-highlight_yellow_dark">
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium selection:bg-highlight_yellow/50 selection:text-black dark:selection:bg-highlight_yellow_dark/10 dark:selection:text-highlight_yellow_dark">Selected Projects</h3>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {PROJECTS.map((project) => (
            <div key={project.name} className="space-y-2">
              ...
              <div className="px-1 selection:bg-highlight_yellow/50 selection:text-black dark:selection:bg-highlight_yellow_dark/10 dark:selection:text-highlight_yellow_dark">
                <a
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-3 text-lg font-medium selection:bg-highlight_yellow/50 selection:text-black dark:selection:bg-highlight_yellow_dark/10 dark:selection:text-highlight_yellow_dark">Publications</h3>
        <div className="flex flex-col space-y-0 selection:bg-highlight_yellow/50 selection:text-black dark:selection:bg-highlight_yellow_dark/10 dark:selection:text-highlight_yellow_dark">
          <AnimatedBackground
            enableHover
          ...
          >
            {BLOG_POSTS.map((post) => (
              <Link
                key={post.uid}
                className="-mx-3 rounded-xl px-3 py-3 grid"
                href={post.link}
                target="_blank"
                data-id={post.uid}
              >
                <div className="relative flex w-full flex-row justify-between">
                  <div className="flex flex-col space-y-1">
                    ...
                    <h2 className="text-sm font-extralight dark:text-zinc-400">
                      {post.description}
                    </h2>
                  </div>
                  <div>
